    ...
    <>
      ...
      <div className="container">
        ...
        <div className="flex justify-center mb-4">
          <div className="inline-flex flex-col md:flex-row justify-center gap-6 shadow-md p-6 rounded-sm border border-slate-300">
            <GameOverSection>
        ...
        <div className="container">
          <p>
            ...
            <a
              className="underline"
              target="_blank"
              href="https://github.com/dewald-els/devjam-quiz-app"
            >
              Dewald Els
            </a>
          </p>
